...
import '../tictacktoe/TikTacToe.css'
...
const TikTacToe = () => {
    ...
    const won = (winner)=>{
        ...
        const reset = ()=>{
            ...
            // let data = ["","","","","","","","",""];
            data.fill("");
            titleRef.current.innerHTML = 'Tic Tack Toe Game In <span>React</span>'
            boxArray.map((e) =>{
                e.current.innerHTML = "";
            })
            setCount(0);
  ...
  return (
    <div className='container'>
        <h1 className="title" ref={titleRef}>Tic Tack Toe Game In <span>React</span></h1>
        <div className="board">
            <div className="row1">
